...
class TravelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create travel" do
    assert_difference('Travel.count') do
      post travels_url, params: { travel: { description: @travel.description, image_url: @travel.image_url, name: @travel.name, price: @travel.price } }
    end
  ...
  test "should update travel" do
    patch travel_url(@travel), params: { travel: { description: @travel.description, image_url: @travel.image_url, name: @travel.name, price: @travel.price } }
